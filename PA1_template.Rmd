...
An histogram is a plot of the frequency of occurrence of certain values. 
```{r plot}
datefreq <- with(totalSteps, rep(date, Total.Steps))
hist(datefreq, breaks = "day", freq = TRUE, col = "green", xlab = "Date",ylab = "Steps", main = "Steps per Day")
```
